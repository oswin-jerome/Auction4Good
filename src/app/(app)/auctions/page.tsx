...
import { Card, Checkbox, Flex, Slider, Text } from "@radix-ui/themes";
...
export default function Auctions() {
  ...
  return (
    <div className="container relative py-4 pt-28 grid md:grid-cols-[250px,1fr] gap-4 ">
      ...
      <section className="grid md:grid-cols-4 grid-rows-2 gap-4">
        {items.map((item, i) => {
          return (
            <Card key={i}>
